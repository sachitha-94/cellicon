...
<div class="div_catr_summary">
<fieldset class="table_catr_summary">
...
//				$step=$prow->min_order_level; 
		...
		<form action="<?php echo JRoute::_ ('index.php'); ?>" method="post" class="inline">
			...
			<button type="submit" class="add_quantity_cart" name="update" title="<?php echo  JText::_ ('COM_VIRTUEMART_CART_UPDATE') ?>" value=" "/><i class="icon-refresh"></i></button>
		</form>
		<a class="remove_from_cart" title="<?php echo JText::_ ('COM_VIRTUEMART_CART_DELETE') ?>" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=cart&task=delete&cart_virtuemart_product_id=' . $prow->cart_item_id) ?>"><i class="icon-trash"></i></a>
	</td>
