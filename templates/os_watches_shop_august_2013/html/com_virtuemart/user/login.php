...
<?php
	...
	<div class="order_view span6">
	    <p><?php echo JText::_('COM_VIRTUEMART_ORDER_ANONYMOUS') ?></p>
	    <form action="<?php echo JRoute::_( 'index.php', 1, $this->useSSL); ?>" method="post" name="com-login" >
	    	<div id="com-form-order-number">
	    		<label class="order_number" for="order_number"><?php echo JText::_('COM_VIRTUEMART_ORDER_NUMBER') ?></label>
	    		<input type="text" id="order_number" placeholder="<?php echo JText::_('COM_VIRTUEMART_ORDER_NUMBER') ?>" name="order_number" class="inputbox" size="18" alt="order_number" />
	    	</div>
...
<div class="form_login">
   <form class="container" id="form-login" action="<?php echo JRoute::_('index.php'); ?>" method="post" name="login">
