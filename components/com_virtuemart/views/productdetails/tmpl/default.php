...
if (VmConfig::get('ask_question', 1) == 1) {
  ...
  <?php $modules =& JModuleHelper::getModules('soc_comments'); foreach ($modules as $module)  { echo JModuleHelper::renderModule($module); } ?>
  </div>
...
<div class="tabs_desc_rev row-fluid">
  ...
  jQuery(document).ready(function($){$('#tabs').tab();});
	...
	<li class="active"><a href="#description" data-toggle="tab"><?php echo JText::_('COM_VIRTUEMART_PRODUCT_DESC_TITLE') ?></a></li>
	<li><a href="#reviews" data-toggle="tab"><?php echo JText::_ ('COM_VIRTUEMART_REVIEWS') ?></a></li>
    </ul>
